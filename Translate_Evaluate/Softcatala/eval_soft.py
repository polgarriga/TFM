...
hyp_flores_ca = read_files("hyp_soft_flores_ca.txt")
hyp_flores_de = read_files("hyp_soft_flores_de.txt")
hyp_wmt_ca = read_files("hyp_soft_wmt_ca.txt")
hyp_wmt_de = read_files("hyp_soft_wmt_de.txt")
...
evaluate(hyp_flores_ca, ref_flores_ca, "soft, flores, de>ca")
evaluate(hyp_flores_de, ref_flores_de, "soft, flores, ca>de")
evaluate(hyp_wmt_ca, ref_wmt_ca, "soft, wmt, de>ca")
evaluate(hyp_wmt_de, ref_wmt_de, "soft, wmt, ca>de")